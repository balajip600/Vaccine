...
if selected == "Dashboard":
    ...
    # Create a figure and plot on that figure explicitly
    ...
    fig, ax = plt.subplots(figsize=(8, 6))  # Create a new figure explicitly
    df_en["h1n1_vaccine"].value_counts(normalize=True).plot(kind="bar", ax=ax)
    st.pyplot(fig)

    print("0 --> People who have chronic condition don't take vaccine, 1 --> People who have chronic condition take vaccine")
    fig, ax = plt.subplots(figsize=(8, 6))  # Create a new figure explicitly
    ...
    # Plot with explicit figure handling
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.boxplot(df_en[['h1n1_worry']], showfliers=True, ax=ax)
    st.pyplot(fig)

    # Another plot with explicit figure handling
    fig, ax = plt.subplots(figsize=(8, 6))
    sns.histplot(df_en['h1n1_awareness'], kde=True, color='blue', bins=30, ax=ax)
    st.pyplot(fig)
